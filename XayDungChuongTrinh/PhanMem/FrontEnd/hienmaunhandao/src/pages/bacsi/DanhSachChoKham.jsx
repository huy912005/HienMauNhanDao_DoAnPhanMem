...
export default function DanhSachChoKham() {
  ...
  const loadData = useCallback(async () => {
    setLoading(true);
    try {
      const res = await donDangKyNvytService.getChoKham(page, PAGE_SIZE);
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1 text-sm">Các tình nguyện viên đã có hồ sơ sức khỏe và chưa hiến máu</p>
      </div>
