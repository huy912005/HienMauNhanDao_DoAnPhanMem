    ...
    <main className="flex-1 w-full">
        ...
        <section id="chien-dich-noi-bat" className="w-[1200px] mx-auto px-4 mb-20">
            ...
            <div className="grid grid-cols-2 gap-8">
                <div className="flex bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-lg transition-shadow">
                    <img src="https://images.unsplash.com/photo-1615461066841-6116e61058f4?auto=format&fit=crop&q=80&w=600"
                        className="w-2/5 object-cover" alt="Campaign" />
                    <div className="p-6 w-3/5 flex flex-col justify-center">
                        <span className="px-3 py-1 bg-red-100 text-red-700 text-[10px] font-black uppercase tracking-widest rounded-full w-fit mb-3">Sắp diễn ra</span>
                        <h3 className="text-xl font-bold text-slate-900 mb-2 line-clamp-2">Lễ hội Xuân Hồng 2024 - Khởi đầu mới</h3>
                        <div className="space-y-2 mb-6">
                            <p className="text-sm text-slate-500 flex items-center gap-2"><span className="material-symbols-outlined text-[16px]">calendar_month</span> 15/12/2024</p>
                            <p className="text-sm text-slate-500 flex items-center gap-2"><span className="material-symbols-outlined text-[16px]">location_on</span> Bệnh viện Đà Nẵng</p>
                        </div>
                        <button className="h-10 px-6 bg-primary text-white rounded-lg font-bold text-sm hover:bg-red-800 transition-colors w-full">Đăng ký tham gia</button>
                    </div>
                </div>
                <div className="flex bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-lg transition-shadow">
                    <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=600"
                        className="w-2/5 object-cover" alt="Campaign" />
                    <div className="p-6 w-3/5 flex flex-col justify-center">
                        <span className="px-3 py-1 bg-green-100 text-green-700 text-[10px] font-black uppercase tracking-widest rounded-full w-fit mb-3">Đang nhận đăng ký</span>
                        <h3 className="text-xl font-bold text-slate-900 mb-2 line-clamp-2">Giọt máu hồng - Kết nối yêu thương</h3>
                        <div className="space-y-2 mb-6">
                            <p className="text-sm text-slate-500 flex items-center gap-2"><span className="material-symbols-outlined text-[16px]">calendar_month</span> 20/12/2024</p>
                            <p className="text-sm text-slate-500 flex items-center gap-2"><span className="material-symbols-outlined text-[16px]">location_on</span> Đại học Bách Khoa ĐN</p>
                        </div>
                        <button className="h-10 px-6 bg-primary text-white rounded-lg font-bold text-sm hover:bg-red-800 transition-colors w-full">Đăng ký tham gia</button>
                    </div>
                </div>
