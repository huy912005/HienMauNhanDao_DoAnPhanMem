              ...
              <form className="space-y-8">
                <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input
                      className="w-full h-11 border border-slate-200 rounded-md text-sm bg-slate-50 focus:ring-0 focus:border-slate-200 cursor-not-allowed text-slate-500 font-semibold"
                      readOnly
                      type="text"
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1 border border-slate-100 rounded-lg overflow-hidden">
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-slate-50 hover:bg-slate-50 transition-colors">
                      <p className="text-sm text-slate-700 pr-4">1. Bạn có đang cảm thấy mệt mỏi, sốt hoặc đau họng không?</p>
                    ...
                    {/* Question 2 */}
                    <div className="flex items-center justify-between p-4 border-b border-slate-50 hover:bg-slate-50 transition-colors">
                      <p className="text-sm text-slate-700 pr-4">2. Bạn có đang dùng thuốc kháng sinh hay điều trị bệnh nào không?</p>
                      <div className="flex gap-6 w-32 justify-end shrink-0">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            type="radio"
                    ...
                    {/* Question 3 */}
                    <div className="flex items-center justify-between p-4 border-b border-slate-50 hover:bg-slate-50 transition-colors">
                      <p className="text-sm text-slate-700 pr-4">3. Trong 6 tháng qua, bạn có mắc bệnh truyền nhiễm hay phẫu thuật không?</p>
                      <div className="flex gap-6 w-32 justify-end shrink-0">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            type="radio"
                    ...
                    <div className="flex items-center justify-between p-4 hover:bg-slate-50 transition-colors">
                      <p className="text-sm text-slate-700 pr-4">4. Đối với nữ: Bạn có đang trong kỳ kinh nguyệt, mang thai hoặc cho con bú?</p>
                      <div className="flex gap-6 w-32 justify-end shrink-0">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            type="radio"
                ...
                <div className="flex justify-between items-center pt-4">
                  ...
                  <button
                    onClick={handleNext}
                    className="w-64 h-12 bg-red-700 text-white rounded-md font-bold text-sm flex items-center justify-center gap-2 hover:bg-red-800 transition-all shadow-lg active:scale-[0.98]"
                    type="button"
                  >
