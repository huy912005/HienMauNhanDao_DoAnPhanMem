...
public class TaiKhoanServiceImpl implements TaiKhoanService {
        ...
        public LoginResponse login(LoginRequest loginRequest) {
                ...
                System.out.println(">>> LOGIN DEBUG: Searching for maNV for maTK: [" + maTK + "]");
                
                Optional<com.Nhom20.DoAnPhamMem.entity.NhanVienEntity> nvOpt = nhanVienRepository.findByAccount(maTK);
                String maNVResult = null;
                if (nvOpt.isPresent()) {
                        maNVResult = nvOpt.get().getMaNhanVien().trim();
                        System.out.println(">>> LOGIN DEBUG: FOUND maNV: [" + maNVResult + "]");
                } else {
                        System.out.println(">>> LOGIN DEBUG: NOT FOUND employee for maTK: [" + maTK + "]");
                }
